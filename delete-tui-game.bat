...
>> "%HELPER%" echo del /f /q "%INSTALL_DIR%\tg.sh" ^>nul 2^>^&1
>> "%HELPER%" echo del /f /q "%INSTALL_DIR%\tui-game.exe" ^>nul 2^>^&1
>> "%HELPER%" echo del /f /q "%INSTALL_DIR%\tui-game" ^>nul 2^>^&1
>> "%HELPER%" echo del /f /q "%INSTALL_DIR%\version.exe" ^>nul 2^>^&1
>> "%HELPER%" echo del /f /q "%INSTALL_DIR%\version" ^>nul 2^>^&1
>> "%HELPER%" echo del /f /q "%INSTALL_DIR%\updata.exe" ^>nul 2^>^&1
>> "%HELPER%" echo del /f /q "%INSTALL_DIR%\updata" ^>nul 2^>^&1
