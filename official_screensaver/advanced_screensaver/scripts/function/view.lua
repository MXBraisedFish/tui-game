...
function M.render(state)
  ...
  local title = translate("advanced_screensaver.title")
  local hint = translate("advanced_screensaver.hint")
  local time_text = translate("advanced_screensaver.time") .. ": " .. tostring(math.floor(running_time() / 1000)) .. "s"
