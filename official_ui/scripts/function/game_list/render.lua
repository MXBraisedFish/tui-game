...
local function action_segments(root_state)
  ...
  if root_state.jump then
    ...
    table.insert(segments, C.DEFAULT_TEXT.confirm_key .. " " .. L.language(root_state, "GAME_LIST_CONFIRM", C.DEFAULT_TEXT.confirm))
    table.insert(segments, C.DEFAULT_TEXT.return_key .. " " .. L.language(root_state, "GAME_LIST_CANCEL", C.DEFAULT_TEXT.cancel))
  else
    ...
    table.insert(segments, C.DEFAULT_TEXT.confirm_key .. " " .. L.language(root_state, "GAME_LIST_START", C.DEFAULT_TEXT.start))
    ...
    table.insert(segments, C.DEFAULT_TEXT.order_key .. " " .. L.language(root_state, "GAME_LIST_ORDER", C.DEFAULT_TEXT.order))
    table.insert(segments, C.DEFAULT_TEXT.sort_key .. " " .. L.language(root_state, "GAME_LIST_SORT", C.DEFAULT_TEXT.sort))
    if root_state.pages and root_state.pages > 1 then
      table.insert(segments, C.DEFAULT_TEXT.jump_key .. " " .. L.language(root_state, "GAME_LIST_JUMP", C.DEFAULT_TEXT.jump))
