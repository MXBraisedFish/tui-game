...
M.DEFAULT_TEXT = {
  ...
  mod_on = "Show",
  mod_off = "Hide",
  screensaver_on = "Enable",
  screensaver_off = "Disable",
  second = "s",
  minute = "min",
  never = "Never",
  ordered = "Ordered",
  ...
  option_afk_screensaver = "Enter screen screensaver on idle: ",
  option_info = "Host status display: ",
  option_screensaver_sort = "Screen screensaver display order: ",
  option_boss_sort = "Boss screen display order: ",
  option_screensaver_list = "Screen Screensaver List",
