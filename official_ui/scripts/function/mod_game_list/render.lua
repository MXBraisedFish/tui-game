local C = load_function("mod_game_list/constants.lua")
local L = load_function("mod_game_list/layout.lua")
...
local function draw_colored_header(layout, root_state)
  ...
  elseif sort_value == "debug" then
    sort_text = L.language(root_state, "MOD_LIST_INFO_SORT_DEBUG", C.DEFAULT_TEXT.debug)
  else
