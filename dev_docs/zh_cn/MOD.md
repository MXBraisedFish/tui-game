...
| `mod_name` | <font color="#92cddc">string</font> \| <font color="#92cddc">key</font> | 模组包显示名称，在模组列表展示的包名。可填写字符串或语言键。 |
...
| `version` | <font color="#92cddc">string</font> | 游戏版本号，由作者自行定义。推荐格式：主版本号.次版本号（如 1.0、2.3），可根据需要追加修订号（如 1.0.1）。 |
