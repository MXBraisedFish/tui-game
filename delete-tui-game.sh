...
#!/bin/sh
sleep 1
rm -f "$INSTALL_DIR/tg.sh" "$INSTALL_DIR/tg.bat" "$INSTALL_DIR/tui-game" "$INSTALL_DIR/tui-game.exe" "$INSTALL_DIR/version" "$INSTALL_DIR/version.exe" "$INSTALL_DIR/updata" "$INSTALL_DIR/updata.exe" "$INSTALL_DIR/remove" "$INSTALL_DIR/remove.exe" 2>/dev/null || true
