...
本项目正在进行**大规模架构重构**，当前代码处于**高度不稳定**状态。

- 本文档及代码基于 **1.0 正式版**（稳定）
- **2.0 版本**正在重构中，开发文档仅用于内部测试
- 开发文档目前**无实用价值**，请勿参考
...
(摸鱼这块)
如果觉得不够玩，或者有自己的想法，也可以自己制作模组，提供相当全套的使用说明和适配！
支持所有主流系统的终端：Windows，Linux，MacOS
...
![迷宫逃脱](./image/mazeescape-zh-cn.png)
