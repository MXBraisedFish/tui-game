// 系统请求 API，游戏向宿主发送命令。提供 get_launch_mode, get_best_score, request_exit, request_skip_event_queue, request_clear_event_queue, request_render, request_save_best_score, request_save_game 等函数，将请求转换为 RuntimeCommand 并放入命令队列
