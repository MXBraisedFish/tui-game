...
function M.draw(game_state)
  ...
  canvas_draw_text(2, 3, "Score: " .. tostring(game_state.score), DARK_GREEN)
  canvas_draw_text(18, 3, "Moves: " .. tostring(game_state.moves), DARK_CYAN)
  ...
  canvas_draw_text(game_state.player.x, game_state.player.y, "@", DARK_CYAN, nil, BOLD)
